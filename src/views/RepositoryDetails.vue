...
export default {
  ...
  methods: {
    loadRepository() {
      ...
      axios
        .get(
          `https://api.github.com/repos/${username}/${this.$route.params.name}`
        )
        .then((response) => {
    ...
    loadCommits() {
      ...
      axios
        .get(
          `https://api.github.com/repos/${username}/${this.$route.params.name}/commits`
        )
        .then((response) => {
